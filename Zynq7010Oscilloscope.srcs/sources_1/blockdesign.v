...
module design_1
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:diff_clock:1.0 adc_dco_bd CLK_N" *) (* X_INTERFACE_MODE = "Slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME adc_dco_bd, CAN_DEBUG false, FREQ_HZ 250000000" *) input adc_dco_bd_clk_n;
  (* X_INTERFACE_INFO = "xilinx.com:interface:diff_clock:1.0 adc_dco_bd CLK_P" *) input adc_dco_bd_clk_p;
  ...
  wire adc_dco_bd_clk_n;
  wire adc_dco_bd_clk_p;
  wire clk_wiz_0_key;
  wire clk_wiz_1_clk_iserdes_250m;
  wire clk_wiz_1_clk_iserdes_b_250m;
  ...
  design_1_clk_wiz_1_0 clk_wiz_1
       (.clk_in1_n(adc_dco_bd_clk_n),
        .clk_in1_p(adc_dco_bd_clk_p),
        .clk_iserdes_250m(clk_wiz_1_clk_iserdes_250m),
        .clk_iserdes_b_250m(clk_wiz_1_clk_iserdes_b_250m),
  ...
  design_1_selectio_wiz_0_0 selectio_wiz_0
       (.bitslip(xlconstant_2_dout),
        ...
        .clk_in_n(clk_wiz_1_clk_iserdes_b_250m),
        .clk_in_p(clk_wiz_1_clk_iserdes_250m),
        .clk_reset(1'b0),
